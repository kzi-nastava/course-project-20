...
namespace HealthCareCenter.GUI.Doctor.ViewModels
{
    public class MedicineCreationRequestWindowViewModel
    {
        ...
        public MedicineCreationRequestWindowViewModel(DoctorWindow _window, User _signedUser, IMedicineCreationRequestService medicineCreationRequestService, BaseMedicineCreationRequestRepository medicineCreationRequestRepository)
        {
