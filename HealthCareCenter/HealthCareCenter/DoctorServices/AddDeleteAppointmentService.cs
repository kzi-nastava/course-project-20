...
{
    public class AddDeleteAppointmentService
    {
        private User signedUser;
        private AddAlterAppointmentWindow window;
        private DoctorWindow previousWindow;
        private DoctorWindowService previousService;
        private int selectedAppointmentIndex;
        public AddDeleteAppointmentService(Doctor _signedUser, DoctorWindow scheduleWindow, bool add, DoctorWindowService service, int rowIndex = -1)
        {
