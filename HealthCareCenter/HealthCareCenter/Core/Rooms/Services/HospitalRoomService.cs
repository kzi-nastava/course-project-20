...
namespace HealthCareCenter.Core.Rooms.Services
{
    internal class HospitalRoomService
    {
        ...
        public HospitalRoomService(IHospitalRoomForRenovationService hospitalRoomForRenovationService, AHospitalRoomForRenovationRepository hospitalRoomForRenovationRepository)
        {
